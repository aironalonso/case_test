...
// -------------------------------------------------- //
let firstName = lastName = email = phone = streetAddr = postCode = city = country = labels = "";

// Address class
class Address {
    constructor(id, firstName, lastName, email, phone, streetAddr, postCode, city, country) {
        this.id = id;
